// src/components/process/profilProcess.js
...
export default function ProfilProcess({ navigation }) {
    ...
    <View style={{ flex: 1, backgroundColor: '#F5F7FA' }}>
      ...
      <View style={[S.avatarSection, { backgroundColor: CFG.couleur }]}>
        ...
        <View style={S.roleBadge}>
          <Text style={S.roleBadgeTxt}>CHEF PROCESS</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
              ...
              {!otpSent ? (
                ...
                <>
                  ...
                  <TouchableOpacity onPress={() => { setOtpSent(false); setOtp(''); }}>
                    <Text style={{ color: '#9E9E9E', fontSize: 12, textAlign: 'center' }}>Renvoyer le code</Text>
                  </TouchableOpacity>
                </>
              )}
            </View>
        ...
        <View style={S.card}>
          <TouchableOpacity style={S.securityRow} onPress={() => navigation.navigate('ChangerMotDePasse')}>
            <View style={[S.securityIcon, { backgroundColor: CFG.bg }]}>
...
const S = StyleSheet.create({
  ...
  card:         { backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 4, elevation: 2, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 6, shadowOffset: { width: 0, height: 2 } },
